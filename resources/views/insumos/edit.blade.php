...
<div class="flex items-center gap-2 text-sm text-slate-400 mb-4">
    ...
    <a href="{{ route('insumos.show', $insumo) }}" class="hover:text-blue-600">{{ $insumo->nombre }}</a><span>/</span>
    <span class="text-slate-600 font-medium">Editar</span>
</div>

<div class="max-w-2xl">
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
        <h1 class="text-xl font-extrabold text-slate-800 mb-6">Editar insumo</h1>
